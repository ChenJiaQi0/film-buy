<template>
	<view class="content">
		...
		<view class="banner">
			...
			<view class="tgtit">推广链接：<text class="tugurl">https://github.com/ChenJiaQi0/film-buy</text></view>
...
<script>
	export default {
		data() {
			return {
				providerList: [],
				sourceLink: 'https://github.com/ChenJiaQi0/film-buy',
				type: 0,
			}
		},
		onLoad() {
		...
		methods: {
			...
			sharurl() {
				uni.setClipboardData({
					data: 'https://github.com/ChenJiaQi0/film-buy',
					success: function() {
						console.log('success');
						uni.showModal({
							title: '复制成功',
...
<style>
	...
	.top {
		width: 100%;
		height: 400upx;
		background: url(https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fsafe-img.xhscdn.com%2Fbw1%2Fe097b292-1c06-4e13-8524-2d0af9c19bed%3FimageView2%2F2%2Fw%2F1080%2Fformat%2Fjpg&refer=http%3A%2F%2Fsafe-img.xhscdn.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=auto?sec=1705623179&t=761511c586b349e3eb9a598c02b1434c) repeat-y;
		background-size: 100%;
